...
// Эти переменные нужно задать в Environment на Render
...
// Авторизация в Google API через сервисный аккаунт
...
// Находим файл modules_data.json в папке FOLDER_ID
...
// Читаем JSON из файла (если файла нет – возвращаем пустой объект)
...
// Пишем JSON в файл (создаём или обновляем) – ТУТ уже исправлено
async function writeDataFile(data) {
  const fileId = await findDataFile();

  const media = {
    mimeType: "application/json",
    // главное отличие: строка, а не Buffer/стрим
...
// Сохранение всех данных по модулям
